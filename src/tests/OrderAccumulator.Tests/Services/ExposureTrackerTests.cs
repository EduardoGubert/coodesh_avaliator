...
public class ExposureTrackerTests
{
    ...
    {
        _tracker.Record("PETR4", new Side(Side.BUY), 100m, 28.50m);
    ...
    {
        _tracker.Record("VALE3", new Side(Side.SELL), 50m, 65.00m);
    ...
    {
        _tracker.Record("PETR4", new Side(Side.BUY), 100m, 28.50m); // +2850
        _tracker.Record("PETR4", new Side(Side.SELL), 50m, 29.00m);  // -1450
        _tracker.Record("PETR4", new Side(Side.BUY), 200m, 27.00m); // +5400
    ...
    public void Record_DifferentSymbols_TrackedIndependently()
    {
        _tracker.Record("PETR4", new Side(Side.BUY), 100m, 28.50m);
        _tracker.Record("VALE3", new Side(Side.SELL), 50m, 65.00m);
        _tracker.Record("VIIA4", new Side(Side.BUY), 200m, 3.50m);
    ...
    {
        _tracker.Record("PETR4", new Side(Side.BUY), 100m, 10.00m);
